...
| カテゴリ | 内容 |
|----------|------|
| [概要](api/readme.md) | API 早見表・全体方針 |
| [auth](api/auth/) | 登録・ログイン・凍結・プロフィール |
| [files](api/files/) | アップロード・削除・共有・ゴミ箱 |
| [folders](api/folders/) | 作成・一覧・更新・削除 |
| [search](api/search/) | ファイル名・内容・ベクトル・OCR |
| [common](api/common/) | エラー形式・ページネーション・権限モデル |
...
| [DB 設計](spec/database-design.md) | ER 図・テーブル設計 |
| [インフラ](spec/infra/) | P2P・TURN・OCR・メール等 |
