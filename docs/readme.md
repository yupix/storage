...
詳細な手順・トラブルシューティングは [開発環境](仕様書/開発環境.md) を参照。
...
サービス一覧・ポート・通信経路の詳細 → [アーキテクチャ](仕様書/実装ガイド/アーキテクチャ.md)
...
| カテゴリ | 内容 |
|----------|------|
| [仕様書トップ](仕様書/仕様書.md) | API 早見表・全体方針 |
| [アカウント系](仕様書/アカウント系/) | 登録・ログイン・凍結・プロフィール |
| [ファイル系](仕様書/ファイル系/) | アップロード・削除・共有・ゴミ箱 |
| [フォルダー系](仕様書/フォルダー系/) | 作成・一覧・更新・削除 |
| [検索系](仕様書/検索系/) | ファイル名・内容・ベクトル・OCR |
| [共通](仕様書/共通/) | エラー形式・ページネーション・権限モデル |

### 実装ガイド

| ドキュメント | 内容 |
|--------------|------|
| [開発環境](仕様書/開発環境.md) | ローカル起動・マイグレーション・トラブルシューティング |
| [アーキテクチャ](仕様書/実装ガイド/アーキテクチャ.md) | サービス一覧・ポート・通信経路 |
| [DB スキーマ](仕様書/実装ガイド/DBスキーマ.md) | テーブル定義・リレーション |
| [OpenAPI クライアント](仕様書/実装ガイド/OpenAPIクライアント.md) | 型安全 API クライアントの使い方 |
| [環境変数](仕様書/実装ガイド/環境変数.md) | 各サービスの設定値一覧 |
| [実装順序](仕様書/実装ガイド/実装順序.md) | フェーズ別の推奨実装順 |
